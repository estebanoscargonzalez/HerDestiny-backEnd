Mi Tesis de Ingeniería en Software es una aplicación web que cuenta con un sistema de login y el mockup de un sistema de pagos para un negocio de alquileres de aparatología estética.
